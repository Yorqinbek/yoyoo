    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
           ...
           with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-header">Amallar</li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('addshart')}}"
                           class="nav-link {{ Request::is('admin/addshart') ? 'active' : '' }}">
...
<script src="{{ asset('css/img-previewer.min.js') }}"></script>
